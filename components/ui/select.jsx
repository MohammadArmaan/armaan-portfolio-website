...
function SelectTrigger({
  ...
  return (
    (<SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex h-[48px] w-full items-center justify-between rounded-md border border-foreground/10 bg-background px-4 py-5 text-base text-foreground/80 placeholder:text-muted-foreground outline-none focus:border-primary",
        className
      )}
      {...props}>
      {children}
